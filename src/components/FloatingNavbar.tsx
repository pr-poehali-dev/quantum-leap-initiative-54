        ...
        <div className="flex items-center justify-between">
          <button onClick={() => scrollToSection("home")} className="cursor-pointer">
            <div className="flex items-center gap-2 text-white [text-shadow:_0_2px_8px_rgb(0_0_0_/_40%)]">
              ...
              <span className="font-semibold text-lg font-open-sans-custom tracking-tight">IT Квартирник</span>
            </div>
          </button>
          ...
          <Button
            size="sm"
            onClick={() => scrollToSection("contact")}
            className="bg-white text-black hover:bg-gray-100 [text-shadow:none] font-open-sans-custom"
          >
            Записаться
          </Button>
        </div>
